...
//
//*****************************************************************************
#define EM9304_PATCHES_NUM_PATCHES          6
...
//EM patch run in OTP or IRAM
#if(EM9304FW_RUN_IN_OTP == 1)
#define EM9304_PATCHES_DEST_MEMORY          1
#else
...
//
//*****************************************************************************
extern em9304_container_info_t g_pEm9304Patches[6];

//EM patch run in OTP or IRAM
#if(EM9304FW_RUN_IN_OTP == 1)
extern const uint8_t g_pEm9304PatchesHCICmd[159][68];
#else
extern const uint8_t g_pEm9304PatchesHCICmd[97][68];
#endif
