...
am_hal_pwrctrl_peripheral_control[AM_HAL_PWRCTRL_PERIPH_MAX] =
{
    ...
    {_VAL2FLD(PWRCTRL_DEVPWREN_IOM0, PWRCTRL_DEVPWREN_IOM0_EN),
    ...
    {_VAL2FLD(PWRCTRL_DEVPWREN_BLEL, PWRCTRL_DEVPWREN_BLEL_EN),
    ...
    {AM_REG_PWRCTRL_DEVPWREN_BLEL_EN,
